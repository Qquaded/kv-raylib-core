return {
      ...
      fields = {
        {
          type = "void *",
          name = "ctx",
          description = "Format context (AVFormatContext)"
        },
        {
          type = "void *",
          name = "vctx",
          description = "Video codec context (AVCodecContext)"
        },
        {
          type = "void *",
          name = "frame",
          description = "Video frame (AVFrame)"
        },
        {
          type = "void *",
          name = "sws",
          description = "Sws context (SwsContext)"
        },
        {
          type = "Texture2D",
          name = "texture",
        ...
        },
        {
          type = "int",
          name = "streamIndex",
          description = "Video stream index"
        },
        {
          type = "bool",
          name = "playing",
        ...
        },
        {
          type = "long long",
          name = "nextPts",
          description = "Next frame Presentation Timestamp"
        }
      }
    },
    {
  ...
  functions = {
    ...
    {
      name = "LoadFontShaper",
      description = "Load a FontShaper from a TTF/OTF file at the given base pixel size",
      returnType = "FontShaper *",
      params = {
        {type = "const char *", name = "fileName"},
        {type = "int", name = "fontSize"}
      }
    ...
    {
      name = "LoadFontShaperFromMemory",
      description = "Load a FontShaper from font data in memory",
      returnType = "FontShaper *",
      params = {
        {type = "const char *", name = "fileType"},
        {type = "const unsigned char *", name = "fileData"},
    ...
    {
      name = "IsFontShaperValid",
      description = "Check if a FontShaper is valid (data loaded)",
      returnType = "bool",
      params = {
        {type = "const FontShaper *", name = "shaper"}
      }
    },
    {
      name = "UnloadFontShaper",
      description = "Unload FontShaper from memory and GPU",
      returnType = "void",
      params = {
        {type = "FontShaper *", name = "shaper"}
      }
    },
    {
      name = "DrawTextShaped",
      description = "Draw shaped text (uses HarfBuzz for shaping: joining, RTL, ligatures)",
      returnType = "void",
      params = {
        {type = "FontShaper *", name = "shaper"},
        {type = "const char *", name = "text"},
    ...
    {
      name = "MeasureTextShaped",
      description = "Measure shaped text size",
      returnType = "Vector2",
      params = {
        {type = "FontShaper *", name = "shaper"},
        {type = "const char *", name = "text"},
